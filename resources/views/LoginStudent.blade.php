                        ...
                        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
                                    ...
                                    <h3 class="text-2xl font-bold text-gray-800 mb-4 text-center">Student Login</h3>
                                    <p class="text-gray-600 mb-6 text-center">Join courses, learn from experts, and track your progress.</p>
                                    
                                    <form  action="{{route("student.Login")}}" method="post" id="student-register-form">
                                    @csrf    
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">
                                ...
                                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
                                    ...
                                    <form action="{{route("teacher.Login")}}" method="post" id="teacher-register-form">
                                        @csrf   
